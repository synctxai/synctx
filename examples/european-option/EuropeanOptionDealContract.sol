...
contract EuropeanOptionDealContract is DealBase, Initializable, MetaTxMixin("EuropeanOptionDeal", "1") {
    ...
    function instruction() external pure override returns (string memory) {
        return
            ...
            "5. Verifier reports settlement price on-chain, triggering auto-settlement\n"
            "6. If verification fails/inconclusive/times out: enters Settling for manual negotiation; unwind on timeout\n\n"
